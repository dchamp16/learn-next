...
export default function Blog() {
    ...
    const [randomNum, setRandomNum] = useState<number>(0); // Ensures the initial value is a number
    ...
    return (
        <>
            <h1>Blog</h1>
            <button className="p-2 border-2 hover:bg-amber-100" onClick={getRandomNum}>
                getRandomNum
            </button>
